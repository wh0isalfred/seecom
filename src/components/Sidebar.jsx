        ...
        <div style={{ padding: '32px 32px 36px', flexShrink: 0, opacity: isOpen ? 1 : 0, transition: 'opacity 0.5s 0.5s ease' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px 20px', marginBottom: 20 }}>
            {[
              ...
              { label: 'Returns', route: 'no-return' },
            ].map(({ label, route }) => (
              <a key={label} onClick={() => navigate(route)} style={{ fontFamily: "'Archivo', sans-serif", fontSize: 10, letterSpacing: '0.1em', color: 'rgba(255,255,255,0.3)', textDecoration: 'none', textTransform: 'uppercase', transition: 'color 0.15s', cursor: 'pointer' }}
